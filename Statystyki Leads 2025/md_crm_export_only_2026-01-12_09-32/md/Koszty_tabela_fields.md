# Pola Modułu: Koszty_tabela

## Statystyki

- **Łącznie pól:** 7
- **Pola niestandardowe:** 3
- **Pola standardowe:** 4
- **Pola formuł:** 0
- **Pola lookup:** 1
...
|:-----------------------------------|:--------------|:-------------|:----------------------|:-----------|:---------------|:----------------------|:-------------------|:------------------|:----------------|:--------------------|:-----------------------|:---------|:-------------------|
| Ilość                              | Ilo           | integer      | ✓                     |            |                | Liczba całkowita      |                    |                   |                 |                     |                        |          |                    |
| Kwota                              | Kwota         | double       | ✓                     |            |                | double                |                    |                   |                 |                     |                        |          |                    |
| Nazwa kosztu                       | Nazwa_kosztu  | text         | ✓                     |            |                | Tekst                 |                    |                   | 255             |                     |                        |          |                    |
| Czas Utworzenia                    | Created_Time  | datetime     |                       |            |                | Data i czas           |                    |                   |                 |                     |                        |          |                    |
| Czas modyfikacji                   | Modified_Time | datetime     |                       |            |                | Data i czas           |                    |                   |                 |                     |                        |          |                    |
| Identyfikator elementu nadrzędnego | Parent_Id     | lookup       |                       |            | ✓              | Lookup                |                    | Campaigns         |                 |                     |                        |          |                    |
| Układ                              | Layout        | bigint       |                       |            |                | Liczba (duża)         |                    |                   |                 |                     |                        |          |                    |
